(ns samsara.qanal.core
  ...
  (:require [clojure.edn :as edn]
            ...
            [samsara.qanal.coordinator.coordinator-zookeeper :refer [create-zk-coordinator]]
            [samsara.qanal.worker.kafka-elastic :refer [create-kafka-elastic-worker]]
            [schema.core :as s]
            [taoensso.timbre :as log])
  (:import java.util.UUID))

(def QANAL-ID (delay (str (UUID/randomUUID))))
